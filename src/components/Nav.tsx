    ...
    return (
        <div
            ...
            <div
                ...
                text-black dark:text-white backdrop-blur-md shadow dark:bg-gray-900/80 ${(props.about || props.displayFilter || props.displaySearch) ? "bg-white/80" : "bg-white/40"}`}
            >
                {/* main container */}
                <div className="relative w-full max-w-2xl items-center justify-between flex">
                    ...
                    <div className="flex-1 h-10 flex w-full relative">
                        ...
                        <div className="absolute left-3 top-3 transition">
                            <button className="cursor-pointer"
                                onClick={() => { props.setDisplaySearch(!props.displaySearch); props.setDisplayFilter(false); props.setAbout(false); props.setCurrent(null) }}
                            >
                        ...
                        <div className="max-w-full">
                            ...
                            {/* dropdown menu */}
                            {props.displaySearch && <Search setCurrent={props.setCurrent} displaySearch={props.displaySearch} setDisplaySearch={props.setDisplaySearch} />}
                    ...
                    <div className="absolute right-3 text-sm font-medium items-center flex gap-6">
                        ...
                        <button className="text-gray-900 dark:text-gray-200  cursor-pointer"
                            onClick={() => { props.setAbout(!props.about); props.setDisplayFilter(false); props.setCurrent(null) }}>
                            {t("about")}
                        </button>
