...
export interface IProjectorTypeInfo {
  isFilm: string;
  isLaser: string;
  isDome: string;
  is3D: string;
...
export const ProjectorTypeInfo: IProjectorTypeInfo = {
